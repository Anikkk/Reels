          ...
          <div className='login-card'>
              <Card variant='outlined' >  
                  ...
                  <CardContent>
                      ...
                      <TextField id="outlined-basic1" label="Email" variant="outlined" fullWidth={true} margin='dense' size='small'/> 
                      <TextField id="outlined-basic2" label="Password" variant="outlined" fullWidth={true} margin='dense' size='small'/>
